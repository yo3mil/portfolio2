<template>
  <div class="about grid_2x3">
    <div class="about__graphic">
      <img class="about__graphic-img" src="./../assets/yoyo-noframe.png" alt="yoyo again !">
    </div>
    <div class="about__window">
      ...
      <div class="about__window-portrait">
        <img class="about__window-portrait-img" src="./../assets/portrait.png" alt="selfie">
      </div>
    </div>
  </div>
</template>
